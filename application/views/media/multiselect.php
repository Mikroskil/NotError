...
foreach ($r->result() as $d) {
	...
	<?php
		echo (empty($d->MediaPath)) ? '-' : '<img height="100" width="100" src="'.base_url().'assets/images/timthumb.php?src='.base_url().'assets/images/media/'.$d->MediaPath.'&w=100&h=100&q=20" />'."<hr /><input id='cec-".$sasa."' type='checkbox' mediaid='".$d->MediaID."' title='".$d->MediaName."' src='".$d->MediaPath."' class='selectit' /> <label for='cec-".$sasa."'>Pilih</label>";
	?>
	</li>
	<?php
}
