...
foreach ($r->result() as $d) {
    ...
    <?php
        echo (empty($d->MediaPath)) ? '-' : '<img height="100" width="100" src="'.base_url().'assets/images/timthumb.php?src='.base_url().'assets/images/media/'.$d->MediaPath.'&w=100&h=100&q=20" />'."<hr /><a href='#' mediaid='".$d->MediaID."' title='".$d->MediaName."' src='".$d->MediaPath."' class='selectit ui'>Pilih</a>";
    ?>
    </li>
    <?php
}
